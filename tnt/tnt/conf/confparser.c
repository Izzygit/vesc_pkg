...
int32_t confparser_serialize_tnt_config(uint8_t *buffer, const tnt_config *conf) {
	...
	buffer_append_uint16(buffer, conf->tc_braking_feature_delay1, &ind);
	buffer_append_uint16(buffer, conf->tc_braking_feature_delay2, &ind);
	buffer_append_uint16(buffer, conf->tc_braking_feature_delay3, &ind);
...
bool confparser_deserialize_tnt_config(const uint8_t *buffer, tnt_config *conf) {
	...
	conf->tc_braking_feature_delay1 = buffer_get_uint16(buffer, &ind);
	conf->tc_braking_feature_delay2 = buffer_get_uint16(buffer, &ind);
	conf->tc_braking_feature_delay3 = buffer_get_uint16(buffer, &ind);
...
void confparser_set_defaults_tnt_config(tnt_config *conf) {
	...
	conf->tc_braking_feature_delay1 = APPCONF_TNT_TC_BRAKING_FEATURE_DELAY1;
	conf->tc_braking_feature_delay2 = APPCONF_TNT_TC_BRAKING_FEATURE_DELAY2;
	conf->tc_braking_feature_delay3 = APPCONF_TNT_TC_BRAKING_FEATURE_DELAY3;
